    ...
    <main className="profile">
        <div className="profile__wrapper">
         ...
         <div className="profile__info">
             ...
             <div className="profile__email">
                 ...
                 < Input type={"data"} kind={"profile"} placeholder={"test@test.ru"} disabled={isDisabled} required/>
             </div>
         </div>
        </div>
        <div className="profile__buttons">
            {isEdited ?
                ...
                < Button type={"button"} kind={"saveProfile"} children={"Сохранить"} disabled={isDisabled}/>
                </>
        }
