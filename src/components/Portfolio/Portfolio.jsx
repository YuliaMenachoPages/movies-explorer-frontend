        ...
        <div className="portfolio">
            ...
            <ul className="portfolio__list">
                <li className="portfolio__item">
                    ...
                    </div>} direction={"https://github.com/YuliaMenachoPages/how-to-learn"} target={"_blank"}
                ...
                <li className="portfolio__item">
                    < LinkComp children={<div className="portfolio__wrapper">
                        ...
                        <img src={go} alt="Перейти" className="portfolio__icon"/>
                    </div>} direction={"https://github.com/YuliaMenachoPages/russian-travel"} target={"_blank"}
                               rel={"noopener noreferrer"}/>
                </li>
                <li className="portfolio__item">
                    < LinkComp children={<div className="portfolio__wrapper">
                        ...
                        <img src={go} alt="Перейти" className="portfolio__icon"/>
                    </div>} direction={"https://github.com/YuliaMenachoPages/react-mesto-api-full-gha"}
